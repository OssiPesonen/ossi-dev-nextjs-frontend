...
import { Link, Link as LinkType } from '@/assets/types'
      ...
      <div className="container-lg">
        <div className="row">
          <div className="col-xs-12 col-md" id="logo">
            <a href="/#introduction" onClick={scrollTo} title="To Introduction">
          ...
          <div id="menu-wrapper" className={`col-xs-12 col-lg row${menuOpen ? ' is-open' : ''}`}>
            <nav className="col-xs-12 col-lg-8">
              <ul>
                <li><a href="/#services" onClick={scrollTo}>Services</a></li>
                <li><a href="/#showcases" onClick={scrollTo}>Showcases</a></li>
                <li><a href="/#posts" onClick={scrollTo}>Posts</a></li>
                <li><a href="/#contact-resume" onClick={scrollTo}>Contact & Resume</a></li>
              </ul>
            </nav>
