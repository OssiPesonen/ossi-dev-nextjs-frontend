...
const Top = () => {
  ...
  return (
              ...
              >
                <g>
                  <g>
                    ...
                    <path
                      fill="#222831"
                      d="M23.4,48.1c0-7.1,1.5-13.4,3.7-17.2c0.1-0.1,0-0.3-0.1-0.4c-0.1,0-0.1,0-0.2,0c-9.4,2.9-14.6,12.8-11.8,22.1
    c1.6,5.3,5.7,9.6,10.9,11.5c0.1,0,0.3,0,0.3-0.2c0-0.1,0-0.1,0-0.2C24.5,59.9,23.4,54.3,23.4,48.1z"
                    />
                    <path
                      fill="#222831"
                      d="M37.1,30.5c-0.1,0-0.3,0-0.3,0.2c0,0.1,0,0.2,0,0.2c2.2,3.8,3.7,10.1,3.7,17.2c0,6.2-1.1,11.8-2.8,15.7
    c-0.1,0.1,0,0.3,0.1,0.4c0.1,0,0.1,0,0.2,0c9.2-3.3,14-13.5,10.7-22.7C46.7,36.2,42.5,32.1,37.1,30.5z"
                    />
                    <path
                      fill="#222831"
                      d="M55.2,31h7.9c0.1,0,0.3,0.1,0.3,0.3v32.3c0,0.1-0.1,0.3-0.3,0.3h-7.9c-0.1,0-0.3-0.1-0.3-0.3V31.3
    C54.9,31.1,55,31,55.2,31z"
                    />
                    <path
                      fill="#222831"
                      d="M71.5,31.3c-0.1,0-0.3,0.1-0.3,0.2c0,0.1,0,0.1,0,0.2c1.4,2.2,2.4,6.1,2.4,10.5s-1,8.3-2.4,10.5
    c-0.1,0.1-0.1,0.3,0.1,0.4c0.1,0,0.1,0.1,0.2,0c6-1.2,9.9-7.1,8.7-13.2C79.3,35.6,75.9,32.1,71.5,31.3z"
          ...
          <button
            id="toggle-menu"
            className={`hamburger hamburger--elastic js-hamburger${
              menuOpen ? " is-active" : ""
            }`}
            onClick={toggleMenu}
          ...
          <div
            id="menu-wrapper"
            className={`col-xs-12 col-lg row${menuOpen ? " is-open" : ""}`}
          >
            <nav className="col-xs-12 col-lg-8">
              <ul>
                ...
                <li>
                  <Link href="/#resume" onClick={scrollTo}>
                    Resume
                  </Link>
                </li>
              </ul>
            ...
            <nav
              className="col-xs-12 col-lg-4 text-right"
              id="social-media-menu"
            >
              <ul>
                <li>
                  <a href="mailto:ossi@ossipesonen.fi" aria-label="Email">
                    <IconEnvelope />
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a
                    href="https://github.com/OssiPesonen/"
                    aria-label="Github"
                    rel="noreferrer"
                    target="_blank"
                  >
